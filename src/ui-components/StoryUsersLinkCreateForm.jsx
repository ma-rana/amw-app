...
export default function StoryUsersLinkCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new StoryUsersLink(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "StoryUsersLinkCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
