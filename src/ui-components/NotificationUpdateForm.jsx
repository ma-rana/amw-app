...
export default function NotificationUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setStoryName(cleanValues.StoryName);
    setInviteCode(cleanValues.inviteCode);
    setStoryImageUrl(cleanValues.storyImageUrl);
    setIsRead(cleanValues.isRead);
    setIsStoryJoined(cleanValues.isStoryJoined);
    setRedirectUrl(cleanValues.redirectUrl);
    setMomentId(cleanValues.momentId);
    setErrors({});
  };
